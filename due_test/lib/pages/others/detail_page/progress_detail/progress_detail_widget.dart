...
import 'progress_detail_model.dart';
export 'progress_detail_model.dart';

class ProgressDetailWidget extends StatefulWidget {
  const ProgressDetailWidget({super.key});

  @override
  State<ProgressDetailWidget> createState() => _ProgressDetailWidgetState();
}

class _ProgressDetailWidgetState extends State<ProgressDetailWidget> {
  late ProgressDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProgressDetailModel());
