...
import 'nv_apply_report_model.dart';
export 'nv_apply_report_model.dart';

class NvApplyReportWidget extends StatefulWidget {
  const NvApplyReportWidget({super.key});

  @override
  State<NvApplyReportWidget> createState() => _NvApplyReportWidgetState();
}

class _NvApplyReportWidgetState extends State<NvApplyReportWidget> {
  late NvApplyReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NvApplyReportModel());
