...
class _SignInWidgetState extends State<SignInWidget> {
  ...
  final String domain = '@udn.due.vn';
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                try {
                                  ...
                                  if (_savePassword) {
                                    await _saveLoginInfo(_model.emailAddressTextController.text.trim(),
                                  ...
                                  if (e.code == 'user-not-found') {
                                    await _showErrorDialog('Không tìm thấy tài khoản');
                                  } else if (e.code == 'wrong-password') {
                                    await _showErrorDialog("Sai mật khẩu");
                                  } else {
                                    await _showErrorDialog('Lỗi không xác định');
                                  }
                                }
                              },
                              text: 'Đăng Nhập',
                                ...
                                showDialog(
                                  ...
                                  builder: (BuildContext context) {
                                    return AlertDialog(
                                      ...
                                      content: const Text(
                                        'Vui lòng liên hệ Admin để cấp lại tài khoản đối với Cán Bộ',
                                        style: TextStyle(
                                          fontSize: 16.0,
                                        ),
                                      ),
